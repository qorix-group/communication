...
extern {
    ...
    fn mw_com_gen_ProxyWrapperClass_mw_com_example_IpcBridge_create(handle: &proxy_bridge_rs::HandleType) -> *mut proxy_bridge_rs::ProxyWrapperClass;
    fn mw_com_gen_ProxyWrapperClass_mw_com_example_IpcBridge_delete(proxy: *mut proxy_bridge_rs::ProxyWrapperClass);
    // The following function is per-event per-proxy.
    fn mw_com_gen_ProxyWrapperClass_mw_com_example_IpcBridge_map_api_lanes_stamped_get(proxy: *mut proxy_bridge_rs::ProxyWrapperClass) -> *mut proxy_bridge_rs::NativeProxyEvent<MapApiLanesStamped>;
    // The following four functions are needed per sample type.
    fn mw_com_gen_ProxyEvent_MapApiLanesStamped_get_new_sample(proxy_event: *mut proxy_bridge_rs::NativeProxyEvent<MapApiLanesStamped>, sample_out: *mut sample_ptr_rs::SamplePtr<MapApiLanesStamped>) -> bool;
    fn mw_com_gen_MapApiLanesStamped_get_size() -> u32;
    fn mw_com_gen_SamplePtr_MapApiLanesStamped_get(sample_ptr: *const sample_ptr_rs::SamplePtr<MapApiLanesStamped>) -> *const MapApiLanesStamped;
    fn mw_com_gen_SamplePtr_MapApiLanesStamped_delete(sample_ptr: *mut sample_ptr_rs::SamplePtr<MapApiLanesStamped>);
}
...
impl proxy_bridge_rs::EventOps for MapApiLanesStamped {
    fn get_sample_ref(ptr: &sample_ptr_rs::SamplePtr<Self>) -> &Self {
        unsafe {
            &*mw_com_gen_SamplePtr_MapApiLanesStamped_get(ptr)
        }
    }
    ...
    unsafe fn get_new_sample(proxy_event: *mut proxy_bridge_rs::NativeProxyEvent<Self>) -> Option<sample_ptr_rs::SamplePtr<Self>> {
        let mut sample_ptr = std::mem::MaybeUninit::uninit();
        unsafe {
            if mw_com_gen_ProxyEvent_MapApiLanesStamped_get_new_sample(proxy_event, sample_ptr.as_mut_ptr()) {
...
pub type MapApiLanesStampedEvent = proxy_bridge_rs::ProxyEvent<MapApiLanesStamped, proxy_bridge_rs::ProxyManager<IpcBridgeProxy>>;
...
impl proxy_bridge_rs::ProxyOps for IpcBridgeProxy {
    fn create(handle: &proxy_bridge_rs::HandleType) -> *mut proxy_bridge_rs::ProxyWrapperClass {
        unsafe {
            mw_com_gen_ProxyWrapperClass_mw_com_example_IpcBridge_create(handle)
        }
    }
...
impl IpcBridgeProxy {
    ...
    fn map_api_lanes_stamped(manager: proxy_bridge_rs::ProxyManager<IpcBridgeProxy>) -> proxy_bridge_rs::ProxyEvent<MapApiLanesStamped, proxy_bridge_rs::ProxyManager<IpcBridgeProxy>> {
        unsafe {
            ...
            proxy_bridge_rs::ProxyEvent::new(manager, "map_api_lanes_stamped", |proxy| mw_com_gen_ProxyWrapperClass_mw_com_example_IpcBridge_map_api_lanes_stamped_get(proxy.get_native_proxy()))
        }
    }
