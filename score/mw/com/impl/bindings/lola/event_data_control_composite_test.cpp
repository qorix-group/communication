...
TEST(EventDataControlCompositeGetTimestampTests, CanRetrieveTimestampsAsilQM)
{
    ...
    unit.EventReady(slot_indicators[0], slot_timestamp_0);
    unit.EventReady(slot_indicators[1], slot_timestamp_1);
    unit.EventReady(slot_indicators[2], slot_timestamp_2);
    unit.EventReady(slot_indicators[4], slot_timestamp_4);
