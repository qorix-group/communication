...
{
    return MethodSubscriptionRegistrationGuard(safecpp::MoveOnlyScopedFunction<void()>{
        message_passing_service_instance_scope, [&message_passing_service, asil_level, skeleton_instance_identifier]() {
            message_passing_service.UnregisterOnServiceMethodSubscribedHandler(asil_level,
