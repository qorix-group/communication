    ...
    const ProxyInstanceIdentifier proxy_instance_identifier)
{
    ...
    auto method_call_callback = [this, in_arg_values_storage, return_value_storage, type_erased_element_info]() {
        return IMessagePassingService::MethodCallHandler{
            ...
            [this, in_arg_values_storage, return_value_storage, type_erased_element_info](std::size_t queue_position) {
                ...
                if (type_erased_element_info.in_arg_type_info.has_value())
                {
                    ...
                    in_args_element_storage = GetInArgValuesElementStorage(
                        queue_position, in_arg_values_storage.value(), type_erased_element_info);
                }
                ...
                if (type_erased_element_info.return_type_info.has_value())
                {
                    ...
                    return_arg_element_storage = GetReturnValueElementStorage(
                        queue_position, return_value_storage.value(), type_erased_element_info);
                }
